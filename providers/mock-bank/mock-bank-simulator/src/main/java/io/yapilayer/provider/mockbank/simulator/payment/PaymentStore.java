...
/**
 * In-memory payments. Status auto-advances one step per poll — Pending →
 * AcceptedSettlementInProcess → AcceptedSettlementCompleted — simulating a real payment lifecycle
 * without needing a clock.
 */
@Component
public class PaymentStore {

    public record SimPayment(
            String id,
            String consentId,
            String amount,
            String currency,
