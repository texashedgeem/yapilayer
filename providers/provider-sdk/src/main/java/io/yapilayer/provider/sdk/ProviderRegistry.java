...
/**
 * Runtime registry of bank connectors. Connectors self-register at startup
 * (each connector module ships a Spring configuration that calls
 * {@link #register}); the platform resolves connectors only through this
 * registry, never by direct reference.
 */
