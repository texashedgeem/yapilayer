 ...
 *
 * <p>A connector returns a port only for capabilities it declares in its {@link
 * ProviderDescriptor}; the platform discovers capabilities rather than assuming them.
 * Implementations must be stateless with respect to consent — all consent/session state is threaded
 * through port method parameters.
 */
