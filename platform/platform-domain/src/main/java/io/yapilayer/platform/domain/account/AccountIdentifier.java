...
/**
 * An external scheme identifier for an account, e.g. sort code + account number
 * or IBAN.
 *
 * @param scheme         identification scheme, e.g. {@code UK.OBIE.SortCodeAccountNumber}
 *                       or {@code UK.OBIE.IBAN}
