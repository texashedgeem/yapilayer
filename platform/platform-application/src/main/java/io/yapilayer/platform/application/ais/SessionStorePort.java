...
/**
 * Storage port for provider sessions (access tokens), implemented by
 * platform-persistence.
 *
 * <p>Phase 1 stores tokens unencrypted in the database — an explicit
 * limitation recorded in SECURITY.md; encryption-at-rest lands with the
 * platform-security hardening work.
 */
