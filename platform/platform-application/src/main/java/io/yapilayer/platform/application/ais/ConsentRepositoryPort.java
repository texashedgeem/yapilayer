 ...
 *
 * <p>The OAuth {@code state} value and the client's redirect URI are transport artifacts of the
 * authorisation journey, stored alongside the consent but kept out of the domain aggregate.
 */
